    ...
    <%
        ...
        if (data.getAllInvoicesForCustomer(u.getUserName(), u.getPassword()) != null) {
            ...
            for (int i = 0; i < arIn.size(); i++) {
                ...
                out.println("<tr><td>" + "<p>" + "Total: " + arIn.get(i).getCart().getToal() + " Invoice size: " + arIn.get(i).getCart().size() + " User: " + arIn.get(i).getUser().getUserName() + " Date: " + arIn.get(i).getDate().toString() + "</p>");
